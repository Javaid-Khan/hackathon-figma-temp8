    ...
    <>
      ...
      <div className='w-full flex'>
        ...
        <div className='flex flex-col gap-[24px]'>
         ...
         <p className='text-[16px] leading-[24px] text-[#272343]'>
          ...
          <div className='flex items-center gap-[32px]'>
            ...
            <Image src={"/assets/pinterest.png"} alt="logo" width={20} height={20} />
       ...
       <div className='flex items-center justify-between py-[24px] border-t-[1px] mt-[60px]'>
        <div className='text-[14px] leadin-[21px] text-[#9A9CAA]'>@ 2021 - Blogy - Designed & Develop by <b>JKhan</b></div>

        <div className='text-[#000000c2]'>
          <Image src={"/assets/g-13.png"} alt="VISA" width={227} height={27}/>
        </div>
       </div>
